...
data:extend({{
    ...
    type = "noise-expression",
    name = "ky_aquilo_spawn_island_mask",
    ...
    type = "noise-expression",
    name = "ky_aquilo_aux_scale",
    expression = "2.0"
}, {
    type = "noise-expression",
    name = "ky_aquilo_wobble_x",
...
-- aquilo.autoplace_settings.entity.settings["ice"] = {}
-- aquilo.autoplace_controls["ice"] = {}

local tile_collision_masks = require("__kyran_sa_tweaks__/prototypes/planet/collision-masks")

data.raw["tile"]["ammoniacal-ocean"].collision_mask = tile_collision_masks.new_ammonia_ocean()
data.raw["tile"]["ammoniacal-ocean-2"].collision_mask = tile_collision_masks.new_ammonia_ocean()
data.raw["tile"]["brash-ice"].collision_mask = tile_collision_masks.new_ammonia_ocean()
