function new_vulcanus()
    return {
        property_expression_names = {
            ...
            ["entity:carbon:probability"] = "vulcanus_coal_probability",
            ["entity:carbon:richness"] = "vulcanus_coal_richness",
...
data.raw["planet"]["vulcanus"].map_gen_settings = new_vulcanus()
data.raw["autoplace-control"]["vulcanus_coal"].localised_name = {"", "[entity=carbon] ", {"entity-name.carbon"}}
