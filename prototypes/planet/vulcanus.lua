...
vulcanus.property_expression_names["entity:carbon:probability"] = "vulcanus_coal_probability"
vulcanus.property_expression_names["entity:carbon:richness"] = "vulcanus_coal_richness"
