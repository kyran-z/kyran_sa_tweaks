...
set_conditions("carbon-fiber", conditions.only_gleba())
set_conditions("bioplastic", conditions.only_gleba())
set_conditions("rocket-fuel-from-jelly", conditions.only_gleba())
set_conditions("bioflux", conditions.only_gleba())
set_conditions("jellynut-processing", conditions.only_gleba())
set_conditions("yumako-processing", conditions.only_gleba())
...
set_conditions("holmium-bacteria", conditions.only_fulgora())
set_conditions("holmium-bacteria-cultivation", conditions.only_fulgora())
